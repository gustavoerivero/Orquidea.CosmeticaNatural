 ...
 * @author Gustavo
 */
public class NotificationPanel extends javax.swing.JDialog {
     ...
     * @throws java.text.ParseException Si la conversión de fechas falla.
     */
    public NotificationPanel(java.awt.Frame parent, java.util.ArrayList<Object> notifications) throws java.text.ParseException {
                
        super(parent, true);
        
        initComponents();
                
        int iterator = (notifications.size()/4), index = 0;
        ...
        if(iterator > 0) {
            ...
            for(int i = 0; i < iterator; i++) {
                setInitial(pan, 
                        (char) notifications.get(index),
                        String.valueOf(notifications.get(index+1)),
                        String.valueOf(notifications.get(index+2)),
                        new java.text.SimpleDateFormat("yyyy-MM-dd").parse(String.valueOf(notifications.get(index+3)))
                );
                index+=4;
            }
        } else {
    ...
    private void initComponents() {
        ...
        pan.setMaximumSize(new java.awt.Dimension(4000, 4000));
